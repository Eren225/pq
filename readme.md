# PQ_Counter - Liège Kots

## 📝 Présentation du projet
PQ_Counter est une application web professionnelle et minimaliste permettant de gérer la consommation de rouleaux de papier toilette au sein d'une colocation (désignée sous le nom de **Liège Kots**). 
...
*Cette section sera enrichie au fur et à mesure du développement de l'application React/Vite.*
